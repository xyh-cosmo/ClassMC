...
#CCFLAG = -g -fPIC
#LDFLAG = -g -fPIC
CCFLAG = -fPIC -Wno-unused-result -Wno-maybe-uninitialized -Wno-misleading-indentation -Wno-unknown-pragmas -Wno-unused-variable 

CCFLAG += -Wno-strict-overflow -Wno-format-overflow # to suppress annoying warnings ...
LDFLAG = -fPIC
...
%.o:  %.c .base
	cd $(WRKDIR);$(CC) $(OPTFLAG) $(OMPFLAG) $(CCFLAG) $(DDEFLAG) $(INCLUDES) -c ../$< -o $*.o
