...
double Likelihood_WMAP9(imcmc_double	&full_params,
    ...
    Data_WMAP9	*wmap9 = static_cast<Data_WMAP9*>(data);
...
#ifdef USE_INTEL
    #if defined(USE_LOWELL_TBEB) || defined(USE_HIGHELL_TB)
        wmap_likelihood_9yr_mp_wmap_likelihood_compute_(cltt,clte,cltb,clee,cleb,clbb,like);
    #else
        wmap_likelihood_9yr_mp_wmap_likelihood_compute_(cltt,clte,clee,clbb,like);
    #endif
#elif USE_GFORTRAN
    #if defined(USE_LOWELL_TBEB) || defined(USE_HIGHELL_TB)
        __wmap_likelihood_9yr_MOD_wmap_likelihood_compute(cltt,clte,cltb,clee,cleb,clbb,like);
    #else
        __wmap_likelihood_9yr_MOD_wmap_likelihood_compute(cltt,clte,clee,clbb,like);
    #endif
#endif
