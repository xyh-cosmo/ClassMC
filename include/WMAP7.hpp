...
//	wmap7 like:
#ifdef USE_INTEL
	void wmap_likelihood_7yr_mp_wmap_likelihood_init_(void);
	void wmap_likelihood_7yr_mp_wmap_likelihood_dof_(int *tt_npix, int *teeebb_npix);
	#if defined(USE_LOWELL_TBEB)
	void wmap_likelihood_7yr_mp_wmap_likelihood_compute_(double cltt[],double clte[],double cltb[],double clee[],double cleb[],double clbb[],double *like);
	...
	#endif
#elif USE_GFORTRAN
	void __wmap_likelihood_7yr_MOD_wmap_likelihood_init(void);
    void __wmap_likelihood_7yr_MOD_wmap_likelihood_dof(int *tt_npix, int *teeebb_npix);
    #if defined(USE_LOWELL_TBEB)
    void __wmap_likelihood_7yr_MOD_wmap_likelihood_compute(double cltt[],double clte[],double cltb[],double clee[],double cleb[],double clbb[],double *like);
    #elif defined(USE_HIGHELL_TB)
    void __wmap_likelihood_7yr_MOD_wmap_likelihood_compute(double cltt[],double clte[],double cltb[],double clee[],double cleb[],double clbb[],double *like);
	#else
